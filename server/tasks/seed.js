...
const main = async () => {
  ...
  await siteFunctions.createSite(
    ...
    "Manhattan",
    1886,
    "https://a.cdn-hotels.com/gdcs/production22/d1594/c68e9132-76e7-40fa-9adf-f3cf5f8cf2e3.jpg"
  );
  ...
  await siteFunctions.createSite(
    ...
    "Manhattan",
    1962,
    "https://npplan.com/wp-content/uploads/2017/10/Hamilton-Grange-01.jpg"
  );
  await siteFunctions.createSite(
    "Fort Tryon Park",
    [
  ...
  await siteFunctions.createSite(
    ...
    "Manhattan",
    1869,
    "https://assets.simpleviewinc.com/simpleview/image/fetch/q_75/https://assets.simpleviewinc.com/simpleview/image/upload/crm/newyorkstate/DF_080731_7852a_40967E44-7BCD-4FD2-A1C02A47169A341F_df754733-c75b-bd9d-45a7fd6763a2a2d6.jpg"
  );
  await siteFunctions.createSite(
  ...
  await siteFunctions.createSite(
    ...
    "Manhattan",
    1808,
    "https://www.frommers.com/system/media_items/attachments/000/868/535/s980/Frommers-New-York-City-Castle-Clinton-1190x768.jpg?1648132550"
  );
  await siteFunctions.createSite(
    "St. Paul's Chapel",
    [
    ...
    "Manhattan",
    1766,
    "https://911groundzero.com/wp-content/uploads/2017/07/Chapel1.jpg"
  );
  await siteFunctions.createSite(
  ...
  await siteFunctions.createSite(
    ...
    "Brooklyn",
    1935,
    "https://historichousetrust.org/wp-content/uploads/2021/01/OSH-inline-2-1024x671.jpg"
  );
  await siteFunctions.createSite(
    "Green-Wood Cemetery",
    [
    ...
    "Brooklyn",
    1838,
    "https://www.dominicanabroad.com/wp-content/uploads/2021/12/green-wood-cemetery-entrance.jpg"
  );
  await siteFunctions.createSite(
    "Fort Greene Park",
    [
    ...
    "Brooklyn",
    1850,
    "https://media.timeout.com/images/105765214/image.jpg"
  );
  await siteFunctions.createSite(
    "Brooklyn Bridge",
    [
  ...
  await siteFunctions.createSite(
    ...
    "Brooklyn",
    1895,
    "https://www.heyridge.com/wp-content/uploads/2018/10/2018-CannonEntrance.jpg"
  );
  await siteFunctions.createSite(
    "Barkaloo Cemetery",
    [
  ...
  await siteFunctions.createSite(
    ...
    "Brooklyn",
    1930,
    "https://thecity.brightspotcdn.com/dims4/default/fe55001/2147483647/strip/false/crop/3000x2000+0+0/resize/1486x991!/quality/90/?url=https%3A%2F%2Fcdn.vox-cdn.com%2Fthumbor%2FWUOe5qCMLR0x_38ev76Lh759R5I%3D%2F0x0%3A3000x2000%2F3000x2000%2Ffilters%3Afocal%281500x1000%3A1501x1001%29%2Fcdn.vox-cdn.com%2Fuploads%2Fchorus_asset%2Ffile%2F20002257%2F9c0e68f102046f1cf01bd5c5512cfbcb3d08.jpg"
  );
  await siteFunctions.createSite(
    ...
    "Brooklyn",
    1892,
    "https://hdc.org/wp-content/uploads/2018/06/180403457_dd7c8c03c8_b.jpg"
  );
  await siteFunctions.createSite(
    "Prospect Park",
    [
    ...
    "Brooklyn",
    1867,
    "https://media.timeout.com/images/105304090/750/422/image.jpg"
  );
  await siteFunctions.createSite(
    "Coney Island",
    [
  ...
  await siteFunctions.createSite(
    ...
    "Brooklyn",
    1964,
    "https://files.structurae.net/files/photos/5256/2019-08-31/dsc00266.jpeg"
  );
  await siteFunctions.createSite(
    "Brooklyn Museum",
    [
    ...
    "Brooklyn",
    1898,
    "https://media.timeout.com/images/105770132/image.jpg"
  );
  await siteFunctions.createSite(
    ...
    "Brooklyn",
    1899,
    "https://assets.simpleviewinc.com/simpleview/image/upload/crm/newyorkstate/brooklynchildrensmuseum_julienneschaer_001_0fdfcb52-f4c0-2cb9-2ac96c765fb0a685.jpg"
  );
  await siteFunctions.createSite(
    ...
    "Brooklyn",
    1908,
    "https://www.bam.org/visit_assets/images/venues/Harvey-Theater.jpg"
  );
  await siteFunctions.createSite(
    "Fort Wadsworth",
    [
  ...
  await siteFunctions.createSite(
    ...
    "Staten Island",
    1906,
    "https://live.staticflickr.com/6026/5941302380_b380c4fd08_b.jpg"
  );
  await siteFunctions.createSite(
  ...
  await siteFunctions.createSite(
    ...
    "Bronx",
    2008,
    "https://www.ballparksofbaseball.com/wp-content/uploads/2016/03/yankee_topv2.jpg"
  );
  await siteFunctions.createSite(
    ...
    "Bronx",
    1891,
    "https://www.nycgo.com/images/venues/1118/newyorkbotanicalgarden-christopherpostlewaite__large.jpg"
  );
  await siteFunctions.createSite(
    "Pelham Bay Park",
    [
    ...
    "Bronx",
    1888,
    "https://media.timeout.com/images/102295107/image.jpg"
  );
  await siteFunctions.createSite(
    "Woodlawn Cemetery",
    [
    ...
    "Bronx",
    1863,
    "https://uncoveringnewyork.com/wp-content/uploads/2019/11/Woodlawn-Cemetery-6218.jpg"
  );
  await siteFunctions.createSite(
    "Van Cortlandt Park",
    [
    ...
    "Bronx",
    1888,
    "https://media.timeout.com/images/100724407/image.jpg"
  );
  await siteFunctions.createSite(
    "Bronx Zoo",
    [
  ...
  await siteFunctions.createSite(
    ...
    "Bronx",
    1843,
    "https://media.timeout.com/images/103613979/image.jpg"
  );
  await siteFunctions.createSite(
    ...
    "Bronx",
    1812,
    "https://historichousetrust.org/wp-content/uploads/2020/10/In-Line-Image_0005_Poe-Cottage-in-line-photo-1-1024x670.jpg"
  );
  await siteFunctions.createSite(
    ...
    "Bronx",
    1967,
    "https://wp.zillowstatic.com/streeteasy/2/GettyImages-626346156-resized-f3c71f.jpg"
  );
  await siteFunctions.createSite(
    "Lorelei Fountain",
    [
    ...
    "Bronx",
    1899,
    "https://mermaidsofearth.com/wp-content/gallery/heinrichheine/BrianBenton4a-scaled.jpg"
  );
  await siteFunctions.createSite(
    "Flushing Meadows",
    [
    ...
    "Queens",
    1939,
    "https://media.timeout.com/images/100432609/image.jpg"
  );
  await siteFunctions.createSite(
    "Silvercup Studios",
    [
    ...
    "Queens",
    1983,
    "https://images.squarespace-cdn.com/content/v1/55fffcc7e4b07f44d4c9031a/1625862768118-83ZESEVF05V2L9CKYHS6/42-2222Ave_exterior_24_20191023_CTC_9351.jpg?format=1500w"
  );
  await siteFunctions.createSite(
    ...
    "Queens",
    1921,
    "https://queenspost.com/wp-content/uploads/2020/05/iStock-KaufmanAstoria.jpg"
  );
  await siteFunctions.createSite(
    "Aqueduct Racetrack",
    [
    ...
    "Queens",
    1894,
    "https://www.thoroughbredracing.com/media/filer_public_thumbnails/filer_public/5f/9f/5f9f1e81-db2f-40f9-861f-3b5be0327339/aqueduct-racetrack-wood-day.jpg__760x480_q85_crop_subsampling-2_upscale.jpg"
  );
  await siteFunctions.createSite(
    "Fort Tilden",
    [
    ...
    "Queens",
    1917,
    "https://img.atlasobscura.com/PsnJwDEgTl7Yd8MZ_y0OmoabFf9Ou5jIxcHxQMnCAY0/rs:fill:780:520:1/g:ce/q:81/sm:1/scp:1/ar:1/aHR0cHM6Ly9hdGxh/cy1kZXYuczMuYW1h/em9uYXdzLmNvbS91/cGxvYWRzL3BsYWNl/X2ltYWdlcy9kZjA0/MDZiMTdjZWMyNWNm/YzJfSU1HXzEzMDYu/SlBH.jpg"
  );
  await siteFunctions.createSite(
  ...
  await siteFunctions.createSite(
    ...
    "Queens",
    1972,
    "https://media.timeout.com/images/102923900/image.jpg"
  );
  await siteFunctions.createSite(
    "John Bowne House",
    [
    ...
    "Queens",
    1661,
    "https://hdc.org/wp-content/uploads/2018/07/364943019_f864da4b46_b.jpg"
  );
  await siteFunctions.createSite(
    "King Manor",
    [
    ...
    "Queens",
    1806,
    "https://ohny.org/wp-content/uploads/2022/09/Q_KingManorMuseumandRufusKingPark_Credit_KelseyBrow.jpg"
  );
  await siteFunctions.createSite(
    "MoMA PS1",
    [
    ...
    "Queens",
    1971,
    "https://cdn.filepicker.io/api/file/HfSQL9EnQV6z185Arsvj"
  );
  await siteFunctions.createSite(
    "Jacob Riis Park",
    [
    ...
    "Queens",
    1937,
    "https://npplan.com/wp-content/uploads/2017/09/Gateway-397.jpg"
  );
  console.log("...")
